...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *  배열의 사용 방법
        *  1. 배열의 선언        // 변수가 Stack에 저장된다. (배열의 주소를 저장할 수 있는 공간을 만든다)
        *  2. 배열의 할당        // new 연산자는 할당 연산자 이다.(Heap 메모리에 공간이 생긴다. 배열이 Heap에 저장된다.)
        *  3. 배열의 인덱스 공간에 값 대입
        * */
...
//        iarr = new int[];      // 크기를 지정해 주지 않아서 에러 발생
        ...
        *  동일객체인지 비교할때 사용할 목적으로 쓰여지며, 동등객체를 동일 객체 취급하기 위한 용도로 overiding 해서 사용한다.
